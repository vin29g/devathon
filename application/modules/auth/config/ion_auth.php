 ...
 */
$config['site_title']                 = "TAPS";       // Site Title, example.com
$config['admin_email']                = "anmoluday@gmail.com"; // Admin Email, admin@example.com
$config['default_group']              = 'stud';           // Default group, use name
 ...
 */
  //In gmail, MUST BE DONE!!!
        //aaccount settings->security-> allow less secure apps to apps : enable
