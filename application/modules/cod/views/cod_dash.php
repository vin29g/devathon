...
<!-- >>>>>>> 3673d66392f045e4d197145298cb8f9b316596a5 -->
						...
						<li class="user-details cyan darken-2">
							<div class="row">
								<div class="col col s4 m4 l4">
									<a href="<?php echo base_url('student/upload/upload_photo')?>" style="display:inline;"> <img src="<?php if (file_exists('./assets/stud_uploads/'.$user['userid'].'.jpg')){echo base_url('assets/stud_uploads/'.$user['userid'].'.jpg');} else {echo base_url('assets/materialize/images/avatar.jpg');}?>" alt="" class="circle responsive-img valign profile-image"></a>
								</div>
